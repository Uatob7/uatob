...
export default function DriverSignupLanding() {
  ...
  const SIGNUP_URL = 'https://uatob.com/driver/signup?city=jacksonville';

  const TICKER = [
    '80% driver split', 'Next-day payouts', 'Zero weekly fees',
    'Jacksonville-first platform', 'Founding driver perks', 'Fair surge pricing',
  ...
  const BENTO = [
    ...
    { icon: MapPin,      title: 'Built for Jacksonville routes',   desc: 'Airport, downtown, Riverside, St. Johns Town Center — demand where you already drive.',  wide: true },
  ];
        ...
        <div style={{ position: 'relative', zIndex: 2, padding: '48px 22px 40px' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', marginBottom: 32 }}>
            <div style={{
              ...
              }}>Recruiting Drivers · Jacksonville, FL</span>
            </div>
          </div>
          ...
          <p style={{
            ...
            Jacksonville's driver-first rideshare platform — built to keep more money
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          <div className="sr" style={{ textAlign: 'center', marginBottom: 28 }}>
            ...
            <p style={{ fontSize: 13, color: T.muted, lineHeight: 1.85, maxWidth: 290, margin: '0 auto' }}>
              Join Jacksonville's first wave of founding drivers — priority onboarding,
