...
export default function DriverSignupLanding() {
  ...
  const SIGNUP_URL = 'https://uatob.com/driver/signup?city=tampa';

  const TICKER = [
    '80% driver split', 'Next-day payouts', 'Zero weekly fees',
    'Tampa-first platform', 'Founding driver perks', 'Fair surge pricing',
  ...
  const BENTO = [
    ...
    { icon: MapPin,      title: 'Built for Tampa routes',   desc: 'Airport, Ybor City, downtown, waterfront — demand where you already drive.',  wide: true },
  ];
        ...
        <div style={{ position: 'relative', zIndex: 2, padding: '48px 22px 40px' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', marginBottom: 32 }}>
            <div style={{
              ...
              }}>Recruiting Drivers · Tampa, FL</span>
            </div>
          </div>
          ...
          <p style={{
            ...
            Tampa's driver-first rideshare platform — built to keep more money
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          <div className="sr" style={{ textAlign: 'center', marginBottom: 28 }}>
            ...
            <p style={{ fontSize: 13, color: T.muted, lineHeight: 1.85, maxWidth: 290, margin: '0 auto' }}>
              Join Tampa's first wave of founding drivers — priority onboarding,
