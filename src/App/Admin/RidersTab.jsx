      ...
      <div style={{ background: C.bg, minHeight: "100vh", fontFamily: font, fontFeatureSettings: "'cv11'", WebkitFontSmoothing: "antialiased" }}>
        <div style={{ maxWidth: 600, margin: "0 auto", padding: "20px 16px 48px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: 8, marginBottom: 18 }}>
            <StatCard icon={<Users size={14} />}         label="Total"     value={counts.all}       color={C.blue}   delay={0} />
            <StatCard icon={<Activity size={14} />}      label="Active"    value={counts.active}    color={C.green}  delay={50} />
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 7, marginBottom: 3, flexWrap: "wrap" }}>
                    ...
                    <Badge status={rider.status} />
                    {(local[rider.uid]?.adminNote || rider.adminNote) && <Flag size={11} color={C.amber} />}
                  </div>
