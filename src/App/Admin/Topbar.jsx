    ...
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          <UaTobIcon size={32} />
          <div>
            <div className="condensed" style={{ fontSize: 9, fontWeight: 800, color: C.textMuted, letterSpacing: "1.2px", lineHeight: 1 }}>
              ADMIN
            </div>
            <div style={{ fontSize: 15, fontWeight: 800, lineHeight: 1, marginTop: 1 }}>{title}</div>
          </div>
        </div>
      </div>
