...
function StepDocuments({ data, setData, errors, uid }) {
  ...
  return (
    <div>
      ...
      <UploadBox label="Vehicle Registration" hint="Take or upload a photo" icon={FileText} accept="image/*" uploaded={data.registration} previewUrl={preview("registration")} uploading={uploadState.registration.uploading} progress={uploadState.registration.progress} error={errors?.registration} onFileSelect={f => uploadFile("registration", f)} onRemove={() => removeSlot("registration")}/>
      <UploadBox label="Proof of Insurance" hint="Take or upload a photo · current &amp; valid" icon={Shield} accept="image/*" uploaded={data.insurance} previewUrl={preview("insurance")} uploading={uploadState.insurance.uploading} progress={uploadState.insurance.progress} error={errors?.insurance} onFileSelect={f => uploadFile("insurance", f)} onRemove={() => removeSlot("insurance")}/>
      <Divider/>
